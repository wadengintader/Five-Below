  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-15">
          <Image
            src="https://i.imgur.com/DxxsqEB.png"
            alt=""
            width={100}
            height={100}
          ...
          />
          <Image
            src="https://i.imgur.com/ncU1HrY.png"
            alt=""
            width={150}
            height={150}
          ...
          />
          <Image
            src="https://i.imgur.com/ZHdyHCb.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/9qhLhe0.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/RguhBP0.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/y9IKI69.png"
            alt=""
            width={80}
            height={80}
